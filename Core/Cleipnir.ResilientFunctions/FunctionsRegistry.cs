    ...
    ) where TParam : notnull
    {
        ...
        lock (_sync)
        {
            ...
            var registration = new FuncRegistration<TParam, TReturn>(
                ...
                storedType,
                _functionStore,
                invoke: async (instance, param, initialState) => (await (await invoker.ScheduleInvoke(instance, param, detach: null, initialState)).Completion(allowPostponedAndSuspended: false)).First(),
    ...
    ) 
    {
        ...
        lock (_sync)
        {
            ...
            var registration = new ParamlessRegistration(
                ...
                storedType,
                _functionStore,
                invoke: async (id, initialState) => { await (await invoker.ScheduleInvoke(id.Value, param: Unit.Instance, detach: null, initialState)).Completion(allowPostponedAndSuspended: false); },
    ...
    ) where TParam : notnull
    {
        ...
        lock (_sync)
        {
            ...
            var registration = new ActionRegistration<TParam>(
                ...
                storedType,
                _functionStore,
                invoke: async (instance, param, initialState) => { await (await rActionInvoker.ScheduleInvoke(instance, param, detach: null, initialState)).Completion(allowPostponedAndSuspended: false); },
