...
/// dead letter queue table - the handle used when deleting or redriving. The position the message had in the
/// message store before it was dead lettered is not retained.
/// </summary>
public record StoredDlqMessage(
    StoredId StoredId,
    long Position,
    byte[] MessageContent,
    byte[] MessageType,
