                ...
                inner: async (Workflow workflow) =>
                {
                    var effect = workflow.Effect;
                        var e1 = effect.Capture(async () =>
                        {
                            ...
                            return await Task.WhenAll(e11, e12, e13);
                        });
                        ...
                        var e2 = effect.Capture(async () =>
                        {
                            ...
                            {
                                await effect.Capture("2.1.1", () => Task.Delay(1000));
                                await effect.Capture("2.1.2", () => Task.Delay(1000));
                                await effect.Capture("2.1.3", () => Task.Delay(1000));
                                await effect.Capture("2.1.4", () => Task.Delay(1000));
                                await effect.Capture("2.1.5", () => Task.Delay(1000));
                                await effect.Capture("2.1.6", () => Task.Delay(1000));
                                await effect.Capture("2.1.7", () => Task.Delay(1000));
                                await effect.Capture("2.1.8", () => Task.Delay(1000));
                                return "2.1";
                            });
