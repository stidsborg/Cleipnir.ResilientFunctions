...
public class StateStoreTests
{
    ...
    private static MariaDbStateStore CreateStateStore()
    {
        var store = new MariaDbStateStore(Sql.ConnectionString, TablePrefix + "_" + System.Guid.NewGuid().ToString("N"));
        return store;
    }
    ...
    public async Task InsertAndReadSingleState()
    {
        ...
        var executor = new MariaDbCommandExecutor(Sql.ConnectionString);
        var id = TestStoredId.Create();
        var state = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes("test content"), Version: 0);
    ...
    public async Task InsertMultipleStatesAtDifferentPositions()
    {
        ...
        var state0 = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes("content at 0"), Version: 0);
        var state5 = new MariaDbStateStore.StoredState(id, Position: 5, Content: Encoding.UTF8.GetBytes("content at 5"), Version: 0);
        var state10 = new MariaDbStateStore.StoredState(id, Position: 10, Content: Encoding.UTF8.GetBytes("content at 10"), Version: 0);
    ...
    public async Task GetMultipleIdsReturnsAllStates()
    {
        ...
        var state1 = new MariaDbStateStore.StoredState(id1, Position: 0, Content: Encoding.UTF8.GetBytes("id1 content"), Version: 0);
        var state2 = new MariaDbStateStore.StoredState(id2, Position: 0, Content: Encoding.UTF8.GetBytes("id2 content"), Version: 0);
        var state3 = new MariaDbStateStore.StoredState(id3, Position: 0, Content: Encoding.UTF8.GetBytes("id3 content"), Version: 0);
    ...
    public async Task UpdateStateIncrementsVersion()
    {
        ...
        var initialState = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes("initial"), Version: 0);
        await executor.ExecuteNonQuery(new StoreCommands([store.Insert(id, initialState)]));

        // Update the state
        var updatedState = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes("updated"), Version: 0);
    ...
    public async Task UpdateWithWrongVersionDoesNotUpdate()
    {
        ...
        var updatedState = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes("should not update"), Version: 999);
        await executor.ExecuteNonQuery(new StoreCommands([store.Update(id, updatedState)]));
    ...
    public async Task DeleteWithEmptyPositionsListDoesNothing()
    {
        ...
        var state = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes("content"), Version: 0);
    ...
    public async Task AddTo0AppendsContentAndIncrementsVersion()
    {
        ...
        var appendState = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes(" appended"), Version: 0);
    ...
    public async Task AddTo0WithWrongVersionDoesNotAppend()
    {
        ...
        var appendState = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes(" should not append"), Version: 999);
        await executor.ExecuteNonQuery(new StoreCommands([store.AddTo0(id, appendState)]));
    ...
    public async Task NullContentCanBeReadBack()
    {
        ...
        var stateWithEmptyContent = new MariaDbStateStore.StoredState(id, Position: 0, Content: [], Version: 0);
    ...
    public async Task MultipleUpdatesIncrementVersionSequentially()
    {
        ...
        var state = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes("v0"), Version: 0);
        await executor.ExecuteNonQuery(new StoreCommands([store.Insert(id, state)]));

        // Update multiple times
        for (int i = 0; i < 5; i++)
        {
            var currentState = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes($"v{i + 1}"), Version: i);
    ...
    public async Task AppendCreatesNewStateAtNextPosition()
    {
        ...
        var state0 = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes("position 0"), Version: 0);
        var state5 = new MariaDbStateStore.StoredState(id, Position: 5, Content: Encoding.UTF8.GetBytes("position 5"), Version: 0);
        await executor.ExecuteNonQuery(new StoreCommands([store.Insert(id, state0)]));
        await executor.ExecuteNonQuery(new StoreCommands([store.Insert(id, state5)]));
    ...
    public async Task AppendToEmptyIdCreatesAtPosition2()
    {
        ...
        var appendState = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes("first append"), Version: 0);
        await executor.ExecuteNonQuery(new StoreCommands([store.Append(id, appendState)]));
    ...
    public async Task MultipleAppendsCreateSequentialPositions()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            var appendState = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes($"append {i}"), Version: 0);
            await executor.ExecuteNonQuery(new StoreCommands([store.Append(id, appendState)]));
        }
    ...
    public async Task BatchInsertMultipleStates()
    {
        ...
        var state0 = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes("batch content 0"), Version: 0);
        var state1 = new MariaDbStateStore.StoredState(id, Position: 1, Content: Encoding.UTF8.GetBytes("batch content 1"), Version: 0);
        var state2 = new MariaDbStateStore.StoredState(id, Position: 2, Content: Encoding.UTF8.GetBytes("batch content 2"), Version: 0);
    ...
    public async Task BatchMixedOperations()
    {
        ...
        var state0 = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes("initial 0"), Version: 0);
        var state1 = new MariaDbStateStore.StoredState(id, Position: 1, Content: Encoding.UTF8.GetBytes("initial 1"), Version: 0);
        await executor.ExecuteNonQuery(new StoreCommands([store.Insert(id, state0)]));
        ...
        var state2 = new MariaDbStateStore.StoredState(id, Position: 2, Content: Encoding.UTF8.GetBytes("new state"), Version: 0);
        var updatedState0 = new MariaDbStateStore.StoredState(id, Position: 0, Content: Encoding.UTF8.GetBytes("updated 0"), Version: 0);
    ...
    public async Task BatchReadMultipleIds()
    {
        ...
        await executor.ExecuteNonQuery(new StoreCommands([
            store.Insert(id1, new MariaDbStateStore.StoredState(id1, 0, Encoding.UTF8.GetBytes("id1 content"), 0)),
            store.Insert(id2, new MariaDbStateStore.StoredState(id2, 0, Encoding.UTF8.GetBytes("id2 content"), 0)),
            store.Insert(id3, new MariaDbStateStore.StoredState(id3, 0, Encoding.UTF8.GetBytes("id3 content"), 0))
        ]));
    ...
    public async Task BatchInsertAcrossMultipleIds()
    {
        ...
        var commands = new StoreCommands([
            store.Insert(id1, new MariaDbStateStore.StoredState(id1, 0, Encoding.UTF8.GetBytes("id1 pos0"), 0)),
            store.Insert(id1, new MariaDbStateStore.StoredState(id1, 1, Encoding.UTF8.GetBytes("id1 pos1"), 0)),
            store.Insert(id2, new MariaDbStateStore.StoredState(id2, 0, Encoding.UTF8.GetBytes("id2 pos0"), 0)),
            store.Insert(id2, new MariaDbStateStore.StoredState(id2, 1, Encoding.UTF8.GetBytes("id2 pos1"), 0))
        ]);
        await executor.ExecuteNonQuery(commands);
