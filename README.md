...
All source code examples together with a ready to run web-api application can be found in this [repository](https://github.com/stidsborg/Cleipnir.ResilientFunctions.Sample.OrderProcessing)
